   ...
   <section class="py-5">
      <div class="container">
         <div class="row justify-content-center">
            <div class="col-lg-10">
               <h1 class="at-quienes-title mb-3 text-center">Cápsulas de salud mental</h1>
               <div class="text-center mb-4">
                  <p class="lead">
                     <strong>Precio:</strong> desde $ 49.00
                     <span class="mx-2">|</span>
                     <strong>Duración:</strong> 25 minutos
                  </p>
               </div>
               <article class="at-tema-description">
                  <p>Encuentros de 25 minutos para personas ocupadas. Perfecto para quienes tienen poco tiempo pero necesitan un espacio de apoyo y orientación.</p>
                  <p>Estas cápsulas están diseñadas para abordar temas específicos de manera eficiente, ofreciéndote herramientas prácticas que puedas aplicar en tu día a día.</p>
                  <p>Ideal para momentos de estrés, ansiedad puntual, toma de decisiones importantes, o simplemente cuando necesitas un espacio para desahogarte y recibir orientación profesional.</p>
               </article>
            </div>
         </div>
      </div>
         ...
         <div class="row justify-content-center">
            <div class="col-md-8 text-center">
               ...
               <div class="d-flex flex-column flex-md-row justify-content-center mt-4">
                  <a href="/register-form" class="btn btn-primary mb-3 mb-md-0 mr-md-3" data-cta="servicio-capsulas-salud-mental">¡Lo quiero!</a>
